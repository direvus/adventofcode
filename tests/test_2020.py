...
def test_y2020d21():
    assert get_day_result(YEAR, 21) == (5, 'mxmxvkd,sqjhc,fvjkl')


def test_y2020d22():
    assert get_day_result(YEAR, 22) == (306, 291)


def test_y2020d23():
    assert get_day_result(YEAR, 23) == ('67384529', 430728)


def test_y2020d24():
    assert get_day_result(YEAR, 24) == (10, 2208)


def test_y2020d25():
    assert get_day_result(YEAR, 25) == (14897079, 0)
